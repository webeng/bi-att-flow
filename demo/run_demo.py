...
if __name__ == "__main__":
    ...
    # python -m squad.prepro --mode dev --single_path /Applications/MAMP/htdocs/bi-att-flow/data/squad/dev-v1.1.json --target_dir inter_single --glove_dir .
    #python run_demo.py --data_dir = "/Applications/MAMP/htdocs/bi-att-flow/inter_single/" --load_path = "/Applications/MAMP/htdocs/bi-att-flow/save/40/save" --shared_path = "/Applications/MAMP/htdocs/bi-att-flow/save/40/shared.json"
